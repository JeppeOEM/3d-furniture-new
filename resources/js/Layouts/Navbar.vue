            ...
            <div class="menubar-content">
                <div class="d-flex justify-content-center align-items-center">
                    ...
                    <a class="menubar-brand ubuntu" :href="route('index')">
                        <img src="/assets/logo.svg"  class="brand-logo" alt="cubicraft">
                ...
                <ul class="menubar-menu">
                        <li class="menu-item">
                            <a class="menu-link-text" :href="route('planner')">Furniture Planner</a>
                        </li>
                        <li class="menu-item active">
                            <a class="menu-link-text" :href="route('editor')">Editor</a>
                        </li>


                        <li  v-if="!user" class="menu-item">
                            <a class="menu-link-text" :href="route('login')">Login</a>
                        </li>
                        <li  v-if="!user" class="menu-item">
                            <a class="menu-link-text" :href="route('user-account.create')">Register</a>    
                        </li>
                                                <li @click="openSavedModal" class="menu-item" v-if="user" >
                        ...
                        <li class="menu-item" v-if="user" >
                            ...
                            <li class="menu-item">
                                <a class="menu-link-text" href="mailto: abc@example.com">Contact</a>
                            </li>
                </ul>
            </div>
        </div>
...
@media screen and (max-width: 768px) {
    ...
    .menubar-content {
        position: relative;
        /* Add relative positioning to the menubar content */
    }

    .menubar-content>* {
        margin-bottom: 0;
        /* Remove bottom margin from menubar content children */
    }
}
</style>
